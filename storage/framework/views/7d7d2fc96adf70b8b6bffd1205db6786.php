        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/main.svg')); ?>" alt="mainlogo">
                </div>
                <div class="col-md-7 order-md-1">
                    ...
                    <div class="row">
                        <div class="d-flex flex-column flex-md-row">
                            <button type="button" class="btn bg-purple text-white btn-1g mb-3 me-md-3 px-4 py-3">Get Started</button>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#"> Get Bootstrap Icons
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/logo-black.svg')); ?>" alt="Bootstrap Logo"
                                style="width: 40px;">
...
<?php /**PATH D:\kuliah\SEMESTER 4\PEMROGRAMAN FRAMEWORK\LARAVEL\praktikum4\resources\views/cloning.blade.php ENDPATH**/ ?>